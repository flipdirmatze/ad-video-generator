 ...
 * Sie verwendet eine OPTIONALE Catch-All Route, um Anfragen mit und ohne Trailing Slash/Sub-paths zu akzeptieren.
 */
export async function POST(request: NextRequest) {
  console.log('Batch callback received (optional catch-all)');
